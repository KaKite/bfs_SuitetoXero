      ...
      array(
        ...
        array(
          ...
          array(
            ...
            10 =>
            array(
              'customCode' => '{if $fields.xero_id_c.value == "" }<input type="button" class="button" id="invFromQuote" onClick="window.location=\'?entryPoint=xeroLink&func=sendQuoToXero&accountID={$fields.billing_account_id.value}&contactID={$fields.billing_contact_id.value}&quoteID={$fields.id.value}&xeroID={$fields.xero_id_c.value}\'" value="Create an Invoice in Xero">{/if}',
            ),
            11 =>
            array(
              'customCode' => '{if $fields.xero_id_c.value != "" }<input type="button" class="button" id="updateInvoiceFromQuote" onClick="window.location=\'?entryPoint=xeroLink&func=sendQuoToXero&accountID={$fields.billing_account_id.value}&contactID={$fields.billing_contact_id.value}&quoteID={$fields.id.value}&xeroID={$fields.xero_id_c.value}\'" value="Update this Invoice in Xero">{/if}',
            ),
